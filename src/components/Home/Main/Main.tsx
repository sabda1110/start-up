...
const Main = () => {
  return (
    <div className=" w-[80%] h-[480px] grid grid-cols-2 mt-16 ">
      ...
      <section className="">
        <h2 className=" text-[2rem] ml-[80px] font-semibold text-[#414141]">
          What We Do ?
        </h2>

        <div className="main-content flex flex-col  gap-y-3 mt-5">
          <section className="flex gap-x-8 ">
            ...
            <div>
              ...
              <p className="text-[0.7rem] w-[60%] text-[#5E5B5B]">
