...
const Header = ({ open }: { open: Function }) => {
  ...
  return (
    <div className=" p-4 sticky shadow-lg bg-white border-b z-50 border-gray-200 top-0 right-0   py-6 w-full h-[92px] flex lg:justify-end md:justify-end justify-between items-center ">
      <HiMenuAlt2
        onClick={() => open(true)}
