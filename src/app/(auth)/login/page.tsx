...
const loginPage = () => {
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center relative">
      <section className="w-[589px] h-[680px] bg-[#f5f5f5] flex flex-col items-center  rounded-lg overflow-hidden border  border-[#d5d5d5]">
        <div
        ...
        <div className="w-[487px] h-[48px] flex gap-3 items-center justify-center bg-white shadow-md rounded-md mt-5">
        ...
        <form className="w-[487px] mt-4">
          ...
          <button className="w-[487px] mt-8 h-[48px] rounded-md bg-[#6258dc]  text-white font-bold text-[0.9rem]">
            Login
          </button>
      ...
      <section className="w-[285px] h-[435px] absolute -z-10   left-[16.5rem] top-2  -rotate-10 ">
        <Image
