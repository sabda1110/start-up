...
const ProfileSettingPage = () => {
  ...
  return (
    <div className=" w-full h-svh  p-4 flex items-center gap-y-5 drop-shadow-md flex-col">
      ...
      <div className=" w-[80%]  bg-[#F9FAFB] p-4 border-2 border-gray-200 rounded-lg shadow-md">
        ...
        <div className=" flex justify-end  mt-5">
          <button className="  border p-2 px-10 bg-blue-500 hover:bg-blue-600  text-white font-semibold drop-shadow-lg text-xl rounded-md ">
            Submit
          </button>
        </div>
      </div>
